...
export const Detail = React.memo(() => {
  ...
  return <>
    ...
    <Grid columns={1} style={{ padding: '0 10px', marginTop: 10 }}>
        ...
        <Grid columns={2}>
            <GridItem>
                售价：{Number(home.pricing) / 1e6} 万
            </GridItem>
            <GridItem>
                挂牌：{home.first_upload_at?.substring(0, 10)}
            </GridItem>
            <GridItem>
            ...
            <GridItem>
                面积：{Number(home.squaremeter) / 100} 平方米
            </GridItem>
            <GridItem>
                楼型：{home.total_floor} 层
            </GridItem>
            <GridItem>
                朝向：南侧
            </GridItem>
            <GridItem>
                年代：{home.first_upload_at?.substring(0, 4)}
            </GridItem>
        </Grid>
    </Grid>
    <Grid columns={1} style={{ padding: '0 10px', marginTop: 10 }}>
